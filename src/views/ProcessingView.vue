...
<template>
    <Input_subheader :text_3="subheader_processing"></Input_subheader>
    <Input_processing :color_green="color_green" :color_white="color_white" :color_lightgrey="color_lightgrey"></Input_processing>
