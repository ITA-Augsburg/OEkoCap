...
<template>
    ...
    :shred_1_gwp_prop=shred_1_gwp_prop
    :shred_1_cost_prop=shred_1_cost_prop
    :shred_2_type_prop=shred_2_type_prop
    :shred_2_ml_prop=shred_2_ml_prop
    :shred_2_gwp_prop=shred_2_gwp_prop
    :shred_2_cost_prop=shred_2_cost_prop
